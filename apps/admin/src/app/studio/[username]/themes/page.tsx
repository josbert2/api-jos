...
function ThemeCard({ theme }: { theme: BuiltinTheme }) {
  return (
    <div className="group w-full flex flex-col items-center p-5 overflow-hidden cursor-pointer">
      <div className="w-full translate-y-[12px] group-hover:translate-y-0 transition-transform duration-300 ease-[cubic-bezier(0.23,1,0.32,1)]">
        <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden">
          {/* Scoped CSS vars — override global tokens for this preview only */}
...
export default function ThemesPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Search bar */}
      <div className="sticky top-0 z-10 border-b border-border/50 bg-background px-4 py-2.5" style={{ borderBottomWidth: '0.5px' }}>
        <input
          type="text"
